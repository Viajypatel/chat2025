...
const Login = () => {
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post(`http://137.97.126.110:8080/api/v1/user/login`, user, {
        headers: {
  ...
  return (
    <div className="w-full max-w-sm mx-auto px-4 sm:max-w-md md:max-w-lg lg:max-w-md">
